...
### Changed
 ...
 - Dropped some unused dependencies to make for a smaller/quicker build

## [1.9.0]

### Added

- A new config option, `use_rustls` to enable support for TLS 1.3 on hosts where `native-tls` does not support it (thanks, frodeaa!)
